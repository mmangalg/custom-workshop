...
export declare class CfnAddon extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnAddon;
    /**
     ...
     */
    constructor(scope: cdk.Construct, id: string, props: CfnAddonProps);
    /**
...
export declare class CfnIdentityProviderConfig extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnIdentityProviderConfig;
    /**
     ...
     * @param props - resource properties
     */
    constructor(scope: cdk.Construct, id: string, props: CfnIdentityProviderConfigProps);
    /**
     * Examines the CloudFormation resource and discloses attributes.
     *
     * @param inspector - tree inspector to collect and process attributes
