function _aws_cdk_pipelines_CdkPipelineProps(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.dockerCredentials))
            _aws_cdk_pipelines_DockerCredential(p.dockerCredentials);
...
function _aws_cdk_pipelines_SimpleSynthOptions(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.additionalArtifacts))
            _aws_cdk_pipelines_AdditionalArtifact(p.additionalArtifacts);
        if ("buildSpec" in p)
        ...
        if (!visitedObjects.has(p.rolePolicyStatements))
            require("@aws-cdk/aws-iam/.warnings.jsii.js")._aws_cdk_aws_iam_PolicyStatement(p.rolePolicyStatements);
...
function _aws_cdk_pipelines_ShellScriptActionProps(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.additionalArtifacts))
            require("@aws-cdk/aws-codepipeline/.warnings.jsii.js")._aws_cdk_aws_codepipeline_Artifact(p.additionalArtifacts);
        if ("bashOptions" in p)
        ...
        if (!visitedObjects.has(p.useOutputs))
            _aws_cdk_pipelines_StackOutput(p.useOutputs);
        if ("vpc" in p)
...
function _aws_cdk_pipelines_ShellStepProps(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.additionalInputs))
            _aws_cdk_pipelines_IFileSetProducer(p.additionalInputs);
        if (!visitedObjects.has(p.envFromCfnOutputs))
            require("@aws-cdk/core/.warnings.jsii.js")._aws_cdk_core_CfnOutput(p.envFromCfnOutputs);
...
function _aws_cdk_pipelines_StackDeploymentProps(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.assets))
            _aws_cdk_pipelines_StackAsset(p.assets);
    }
    finally {
        visitedObjects.delete(p);
    }
...
function _aws_cdk_pipelines_StageDeploymentProps(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.post))
            _aws_cdk_pipelines_Step(p.post);
        if (!visitedObjects.has(p.pre))
            _aws_cdk_pipelines_Step(p.pre);
        if (!visitedObjects.has(p.stackSteps))
            _aws_cdk_pipelines_StackSteps(p.stackSteps);
    }
    finally {
        visitedObjects.delete(p);
    }
...
function _aws_cdk_pipelines_StackSteps(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.changeSet))
            _aws_cdk_pipelines_Step(p.changeSet);
        if (!visitedObjects.has(p.post))
            _aws_cdk_pipelines_Step(p.post);
        if (!visitedObjects.has(p.pre))
            _aws_cdk_pipelines_Step(p.pre);
...
function _aws_cdk_pipelines_CodeBuildOptions(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.rolePolicy))
            require("@aws-cdk/aws-iam/.warnings.jsii.js")._aws_cdk_aws_iam_PolicyStatement(p.rolePolicy);
        if (!visitedObjects.has(p.securityGroups))
            require("@aws-cdk/aws-ec2/.warnings.jsii.js")._aws_cdk_aws_ec2_ISecurityGroup(p.securityGroups);
    }
    finally {
...
function _aws_cdk_pipelines_ExternalDockerCredentialOptions(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.usages))
            _aws_cdk_pipelines_DockerCredentialUsage(p.usages);
    }
    finally {
        visitedObjects.delete(p);
    }
