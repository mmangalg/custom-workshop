...
function _aws_cdk_aws_apigateway_RestApiOptions(p) {
    ...
    if (!visitedObjects.has(p.endpointTypes))
        _aws_cdk_aws_apigateway_EndpointType(p.endpointTypes);
...
function _aws_cdk_aws_apigateway_MethodResponse(p) {
    ...
    if (!visitedObjects.has(p.responseModels))
        _aws_cdk_aws_apigateway_IModel(p.responseModels);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigateway_VpcLinkProps(p) {
    ...
    if (!visitedObjects.has(p.targets))
        require("@aws-cdk/aws-elasticloadbalancingv2/.warnings.jsii.js")._aws_cdk_aws_elasticloadbalancingv2_INetworkLoadBalancer(p.targets);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigateway_StageProps(p) {
    ...
    if (!visitedObjects.has(p.methodOptions))
        _aws_cdk_aws_apigateway_MethodDeploymentOptions(p.methodOptions);
...
function _aws_cdk_aws_apigateway_ApiKeyProps(p) {
    ...
    if (!visitedObjects.has(p.resources))
        _aws_cdk_aws_apigateway_IRestApi(p.resources);
    if (!visitedObjects.has(p.defaultCorsPreflightOptions))
        _aws_cdk_aws_apigateway_CorsOptions(p.defaultCorsPreflightOptions);
    if (!visitedObjects.has(p.defaultIntegration))
        _aws_cdk_aws_apigateway_Integration(p.defaultIntegration);
...
function _aws_cdk_aws_apigateway_EndpointConfiguration(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.types))
        _aws_cdk_aws_apigateway_EndpointType(p.types);
    if (!visitedObjects.has(p.vpcEndpoints))
        require("@aws-cdk/aws-ec2/.warnings.jsii.js")._aws_cdk_aws_ec2_IVpcEndpoint(p.vpcEndpoints);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigateway_CfnDocumentationPartProps(p) {
    ...
    if (!visitedObjects.has(p.location))
        _aws_cdk_aws_apigateway_CfnDocumentationPart_LocationProperty(p.location);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigateway_CognitoUserPoolsAuthorizerProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.cognitoUserPools))
        require("@aws-cdk/aws-cognito/.warnings.jsii.js")._aws_cdk_aws_cognito_IUserPool(p.cognitoUserPools);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigateway_UsagePlanPerApiStage(p) {
    ...
    if (!visitedObjects.has(p.stage))
        _aws_cdk_aws_apigateway_Stage(p.stage);
    if (!visitedObjects.has(p.throttle))
        _aws_cdk_aws_apigateway_ThrottlingPerMethod(p.throttle);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_apigateway_RateLimitedApiKeyProps(p) {
    ...
    if (!visitedObjects.has(p.apiStages))
        _aws_cdk_aws_apigateway_UsagePlanPerApiStage(p.apiStages);
...
function _aws_cdk_aws_apigateway_MethodOptions(p) {
    ...
    if (!visitedObjects.has(p.methodResponses))
        _aws_cdk_aws_apigateway_MethodResponse(p.methodResponses);
    if (!visitedObjects.has(p.requestModels))
        _aws_cdk_aws_apigateway_IModel(p.requestModels);
...
function _aws_cdk_aws_apigateway_JsonSchema(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.additionalItems))
        _aws_cdk_aws_apigateway_JsonSchema(p.additionalItems);
    if (!visitedObjects.has(p.allOf))
        _aws_cdk_aws_apigateway_JsonSchema(p.allOf);
    if (!visitedObjects.has(p.anyOf))
        _aws_cdk_aws_apigateway_JsonSchema(p.anyOf);
    if (!visitedObjects.has(p.contains))
        _aws_cdk_aws_apigateway_JsonSchema(p.contains);
    if (!visitedObjects.has(p.definitions))
        _aws_cdk_aws_apigateway_JsonSchema(p.definitions);
    ...
    if (!visitedObjects.has(p.oneOf))
        _aws_cdk_aws_apigateway_JsonSchema(p.oneOf);
    if (!visitedObjects.has(p.patternProperties))
        _aws_cdk_aws_apigateway_JsonSchema(p.patternProperties);
    if (!visitedObjects.has(p.properties))
        _aws_cdk_aws_apigateway_JsonSchema(p.properties);
...
module.exports = { print, _aws_cdk_aws_apigateway_ApiKeySourceType, _aws_cdk_aws_apigateway_EndpointType, _aws_cdk_aws_apigateway_AuthorizationType, _aws_cdk_aws_apigateway_ContentHandling, _aws_cdk_aws_apigateway_IntegrationType, _aws_cdk_aws_apigateway_PassthroughBehavior, _aws_cdk_aws_apigateway_ConnectionType, _aws_cdk_aws_apigateway_MethodLoggingLevel, _aws_cdk_aws_apigateway_Period, _aws_cdk_aws_apigateway_JsonSchemaVersion, _aws_cdk_aws_apigateway_JsonSchemaType, _aws_cdk_aws_apigateway_SecurityPolicy, _aws_cdk_aws_apigateway_IModel, _aws_cdk_aws_apigateway_AccessLogDestinationConfig, _aws_cdk_aws_apigateway_RestApiAttributes, _aws_cdk_aws_apigateway_AddApiKeyOptions, _aws_cdk_aws_apigateway_CfnAccountProps, _aws_cdk_aws_apigateway_DomainNameAttributes, _aws_cdk_aws_apigateway_CfnResourceProps, _aws_cdk_aws_apigateway_CfnUsagePlanKeyProps, _aws_cdk_aws_apigateway_ApiDefinitionS3Location, _aws_cdk_aws_apigateway_CfnDocumentationVersionProps, _aws_cdk_aws_apigateway_ThrottleSettings, _aws_cdk_aws_apigateway_CfnApiMappingV2Props, _aws_cdk_aws_apigateway_CfnDeploymentV2Props, _aws_cdk_aws_apigateway_Cors, _aws_cdk_aws_apigateway_CfnRouteResponseV2Props, _aws_cdk_aws_apigateway_CfnModelV2Props, _aws_cdk_aws_apigateway_JsonWithStandardFieldProps, _aws_cdk_aws_apigateway_RequestValidatorOptions, _aws_cdk_aws_apigateway_IdentitySource, _aws_cdk_aws_apigateway_CfnModelProps, _aws_cdk_aws_apigateway_CfnIntegrationResponseV2Props, _aws_cdk_aws_apigateway_CfnBasePathMappingProps, _aws_cdk_aws_apigateway_CfnAuthorizerProps, _aws_cdk_aws_apigateway_CfnIntegrationV2Props, _aws_cdk_aws_apigateway_RequestContext, _aws_cdk_aws_apigateway_AccessLogField, _aws_cdk_aws_apigateway_RestApiOptions, _aws_cdk_aws_apigateway_ProxyResourceOptions, _aws_cdk_aws_apigateway_LambdaIntegrationOptions, _aws_cdk_aws_apigateway_IApiKey, _aws_cdk_aws_apigateway_ApiKeyOptions, _aws_cdk_aws_apigateway_EmptyModel, _aws_cdk_aws_apigateway_ErrorModel, _aws_cdk_aws_apigateway_IRequestValidator, _aws_cdk_aws_apigateway_IVpcLink, _aws_cdk_aws_apigateway_IGatewayResponse, _aws_cdk_aws_apigateway_IDomainName, _aws_cdk_aws_apigateway_DeploymentProps, _aws_cdk_aws_apigateway_ApiDefinitionConfig, _aws_cdk_aws_apigateway_MTLSConfig, _aws_cdk_aws_apigateway_GatewayResponseOptions, _aws_cdk_aws_apigateway_ResourceAttributes, _aws_cdk_aws_apigateway_BasePathMappingOptions, _aws_cdk_aws_apigateway_CfnClientCertificateProps, _aws_cdk_aws_apigateway_CfnRouteV2Props, _aws_cdk_aws_apigateway_MethodResponse, _aws_cdk_aws_apigateway_HttpIntegrationProps, _aws_cdk_aws_apigateway_CfnVpcLinkProps, _aws_cdk_aws_apigateway_ModelOptions, _aws_cdk_aws_apigateway_CorsOptions, _aws_cdk_aws_apigateway_AwsIntegrationProps, _aws_cdk_aws_apigateway_RequestAuthorizerProps, _aws_cdk_aws_apigateway_TokenAuthorizerProps, _aws_cdk_aws_apigateway_VpcLinkProps, _aws_cdk_aws_apigateway_SpecRestApiProps, _aws_cdk_aws_apigateway_ResourceProps, _aws_cdk_aws_apigateway_ProxyResourceProps, _aws_cdk_aws_apigateway_IStage, _aws_cdk_aws_apigateway_StageProps, _aws_cdk_aws_apigateway_MockIntegration, _aws_cdk_aws_apigateway_ApiKeyProps, _aws_cdk_aws_apigateway_ModelProps, _aws_cdk_aws_apigateway_RequestValidatorProps, _aws_cdk_aws_apigateway_IUsagePlan, _aws_cdk_aws_apigateway_DomainNameProps, _aws_cdk_aws_apigateway_GatewayResponseProps, _aws_cdk_aws_apigateway_EndpointConfiguration, _aws_cdk_aws_apigateway_IntegrationConfig, _aws_cdk_aws_apigateway_IntegrationProps, _aws_cdk_aws_apigateway_ThrottlingPerMethod, _aws_cdk_aws_apigateway_CfnDocumentationPartProps, _aws_cdk_aws_apigateway_CfnGatewayResponseProps, _aws_cdk_aws_apigateway_CognitoUserPoolsAuthorizerProps, _aws_cdk_aws_apigateway_IntegrationResponse, _aws_cdk_aws_apigateway_CfnRequestValidatorProps, _aws_cdk_aws_apigateway_CfnAuthorizerV2Props, _aws_cdk_aws_apigateway_IAccessLogDestination, _aws_cdk_aws_apigateway_HttpIntegration, _aws_cdk_aws_apigateway_StepFunctionsExecutionIntegrationOptions, _aws_cdk_aws_apigateway_StepFunctionsIntegration, _aws_cdk_aws_apigateway_LambdaRestApi, _aws_cdk_aws_apigateway_LambdaRestApiProps, _aws_cdk_aws_apigateway_BasePathMapping, _aws_cdk_aws_apigateway_InlineApiDefinition, _aws_cdk_aws_apigateway_StepFunctionsRestApi, _aws_cdk_aws_apigateway_BasePathMappingProps, _aws_cdk_aws_apigateway_Integration, _aws_cdk_aws_apigateway_ResourceOptions, _aws_cdk_aws_apigateway_MethodProps, _aws_cdk_aws_apigateway_UsagePlanPerApiStage, _aws_cdk_aws_apigateway_CfnDomainNameV2Props, _aws_cdk_aws_apigateway_LambdaAuthorizerProps, _aws_cdk_aws_apigateway_QuotaSettings, _aws_cdk_aws_apigateway_IRestApi, _aws_cdk_aws_apigateway_SpecRestApi, _aws_cdk_aws_apigateway_Deployment, _aws_cdk_aws_apigateway_StageOptions, _aws_cdk_aws_apigateway_RateLimitedApiKeyProps, _aws_cdk_aws_apigateway_LogGroupLogDestination, _aws_cdk_aws_apigateway_S3ApiDefinition, _aws_cdk_aws_apigateway_GatewayResponse, _aws_cdk_aws_apigateway_UsagePlanProps, _aws_cdk_aws_apigateway_IAuthorizer, _aws_cdk_aws_apigateway_AccessLogFormat, _aws_cdk_aws_apigateway_CfnDeploymentProps, _aws_cdk_aws_apigateway_RestApiBaseProps, _aws_cdk_aws_apigateway_MethodDeploymentOptions, _aws_cdk_aws_apigateway_AwsIntegration, _aws_cdk_aws_apigateway_StepFunctionsRestApiProps, _aws_cdk_aws_apigateway_RestApiProps, _aws_cdk_aws_apigateway_Stage, _aws_cdk_aws_apigateway_AssetApiDefinition, _aws_cdk_aws_apigateway_CfnAccount, _aws_cdk_aws_apigateway_CfnBasePathMapping, _aws_cdk_aws_apigateway_CfnAuthorizer, _aws_cdk_aws_apigateway_CfnDocumentationVersion, _aws_cdk_aws_apigateway_CfnModel, _aws_cdk_aws_apigateway_CfnResource, _aws_cdk_aws_apigateway_CfnUsagePlanKey, _aws_cdk_aws_apigateway_CfnApiMappingV2, _aws_cdk_aws_apigateway_CfnDeploymentV2, _aws_cdk_aws_apigateway_CfnIntegrationV2, _aws_cdk_aws_apigateway_CfnModelV2, _aws_cdk_aws_apigateway_CfnIntegrationResponseV2, _aws_cdk_aws_apigateway_CfnRouteResponseV2, _aws_cdk_aws_apigateway_CfnStageV2Props, _aws_cdk_aws_apigateway_CfnDomainNameProps, _aws_cdk_aws_apigateway_LambdaIntegration, _aws_cdk_aws_apigateway_ProxyResource, _aws_cdk_aws_apigateway_RequestValidator, _aws_cdk_aws_apigateway_CfnClientCertificate, _aws_cdk_aws_apigateway_CfnVpcLink, _aws_cdk_aws_apigateway_CfnRouteV2, _aws_cdk_aws_apigateway_CfnRouteResponseV2_ParameterConstraintsProperty, _aws_cdk_aws_apigateway_CfnApiV2Props, _aws_cdk_aws_apigateway_CfnApiKeyProps, _aws_cdk_aws_apigateway_TokenAuthorizer, _aws_cdk_aws_apigateway_RequestAuthorizer, _aws_cdk_aws_apigateway_Method, _aws_cdk_aws_apigateway_CfnDocumentationPart, _aws_cdk_aws_apigateway_CfnDocumentationPart_LocationProperty, _aws_cdk_aws_apigateway_CfnGatewayResponse, _aws_cdk_aws_apigateway_CfnRequestValidator, _aws_cdk_aws_apigateway_CfnAuthorizerV2, _aws_cdk_aws_apigateway_CfnAuthorizerV2_JWTConfigurationProperty, _aws_cdk_aws_apigateway_CfnRouteV2_ParameterConstraintsProperty, _aws_cdk_aws_apigateway_DomainNameOptions, _aws_cdk_aws_apigateway_VpcLink, _aws_cdk_aws_apigateway_UsagePlan, _aws_cdk_aws_apigateway_Authorizer, _aws_cdk_aws_apigateway_Model, _aws_cdk_aws_apigateway_DomainName, _aws_cdk_aws_apigateway_ApiDefinition, _aws_cdk_aws_apigateway_CfnUsagePlanProps, _aws_cdk_aws_apigateway_CfnRestApiProps, _aws_cdk_aws_apigateway_CognitoUserPoolsAuthorizer, _aws_cdk_aws_apigateway_CfnDeployment, _aws_cdk_aws_apigateway_CfnDeployment_AccessLogSettingProperty, _aws_cdk_aws_apigateway_CfnDomainNameV2, _aws_cdk_aws_apigateway_CfnDomainNameV2_DomainNameConfigurationProperty, _aws_cdk_aws_apigateway_MethodOptions, _aws_cdk_aws_apigateway_CfnMethodProps, _aws_cdk_aws_apigateway_RateLimitedApiKey, _aws_cdk_aws_apigateway_CfnDomainName, _aws_cdk_aws_apigateway_CfnDomainName_EndpointConfigurationProperty, _aws_cdk_aws_apigateway_CfnDomainName_MutualTlsAuthenticationProperty, _aws_cdk_aws_apigateway_Resource, _aws_cdk_aws_apigateway_CfnApiKey, _aws_cdk_aws_apigateway_CfnApiKey_StageKeyProperty, _aws_cdk_aws_apigateway_CfnDeployment_CanarySettingProperty, _aws_cdk_aws_apigateway_CfnDeployment_DeploymentCanarySettingsProperty, _aws_cdk_aws_apigateway_CfnStageV2, _aws_cdk_aws_apigateway_CfnStageV2_AccessLogSettingsProperty, _aws_cdk_aws_apigateway_CfnStageProps, _aws_cdk_aws_apigateway_IntegrationOptions, _aws_cdk_aws_apigateway_ApiKey, _aws_cdk_aws_apigateway_CfnApiV2, _aws_cdk_aws_apigateway_CfnApiV2_BodyS3LocationProperty, _aws_cdk_aws_apigateway_RestApi, _aws_cdk_aws_apigateway_CfnDeployment_MethodSettingProperty, _aws_cdk_aws_apigateway_CfnRestApi, _aws_cdk_aws_apigateway_CfnRestApi_EndpointConfigurationProperty, _aws_cdk_aws_apigateway_CfnRestApi_S3LocationProperty, _aws_cdk_aws_apigateway_CfnUsagePlan, _aws_cdk_aws_apigateway_CfnUsagePlan_ThrottleSettingsProperty, _aws_cdk_aws_apigateway_CfnUsagePlan_QuotaSettingsProperty, _aws_cdk_aws_apigateway_CfnStageV2_RouteSettingsProperty, _aws_cdk_aws_apigateway_CfnApiV2_CorsProperty, _aws_cdk_aws_apigateway_CfnMethod, _aws_cdk_aws_apigateway_CfnMethod_IntegrationResponseProperty, _aws_cdk_aws_apigateway_CfnUsagePlan_ApiStageProperty, _aws_cdk_aws_apigateway_CfnStage, _aws_cdk_aws_apigateway_CfnStage_AccessLogSettingProperty, _aws_cdk_aws_apigateway_IResource, _aws_cdk_aws_apigateway_CfnMethod_MethodResponseProperty, _aws_cdk_aws_apigateway_CfnStage_CanarySettingProperty, _aws_cdk_aws_apigateway_ResourceBase, _aws_cdk_aws_apigateway_CfnMethod_IntegrationProperty, _aws_cdk_aws_apigateway_CfnStage_MethodSettingProperty, _aws_cdk_aws_apigateway_ResponseType, _aws_cdk_aws_apigateway_CfnDeployment_StageDescriptionProperty, _aws_cdk_aws_apigateway_JsonSchema, _aws_cdk_aws_apigateway_RestApiBase };
