...
function _aws_cdk_aws_stepfunctions_tasks_EcsRunTaskBaseProps(p) {
    ...
    if (!visitedObjects.has(p.containerOverrides))
        _aws_cdk_aws_stepfunctions_tasks_ContainerOverride(p.containerOverrides);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_EcsEc2LaunchTargetOptions(p) {
    ...
    if (!visitedObjects.has(p.placementConstraints))
        require("@aws-cdk/aws-ecs/.warnings.jsii.js")._aws_cdk_aws_ecs_PlacementConstraint(p.placementConstraints);
    if (!visitedObjects.has(p.placementStrategies))
        require("@aws-cdk/aws-ecs/.warnings.jsii.js")._aws_cdk_aws_ecs_PlacementStrategy(p.placementStrategies);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_ContainerOverride(p) {
    ...
    if (!visitedObjects.has(p.environment))
        _aws_cdk_aws_stepfunctions_tasks_TaskEnvironmentVariable(p.environment);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_EventBridgePutEventsProps(p) {
    ...
    if (!visitedObjects.has(p.entries))
        _aws_cdk_aws_stepfunctions_tasks_EventBridgePutEventsEntry(p.entries);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_ApplicationConfiguration(p) {
    ...
    if (!visitedObjects.has(p.nestedConfig))
        _aws_cdk_aws_stepfunctions_tasks_ApplicationConfiguration(p.nestedConfig);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_CodeBuildStartBuildProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.environmentVariablesOverride))
        require("@aws-cdk/aws-codebuild/.warnings.jsii.js")._aws_cdk_aws_codebuild_BuildEnvironmentVariable(p.environmentVariablesOverride);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_SnsPublishProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.messageAttributes))
        _aws_cdk_aws_stepfunctions_tasks_MessageAttribute(p.messageAttributes);
    visitedObjects.delete(p);
}
function _aws_cdk_aws_stepfunctions_tasks_SageMakerCreateEndpointConfigProps(p) {
    ...
    if (!visitedObjects.has(p.productionVariants))
        _aws_cdk_aws_stepfunctions_tasks_ProductionVariant(p.productionVariants);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_BatchSubmitJobProps(p) {
    ...
    if (!visitedObjects.has(p.dependsOn))
        _aws_cdk_aws_stepfunctions_tasks_BatchJobDependency(p.dependsOn);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_AlgorithmSpecification(p) {
    ...
    if (!visitedObjects.has(p.metricDefinitions))
        _aws_cdk_aws_stepfunctions_tasks_MetricDefinition(p.metricDefinitions);
...
function _aws_cdk_aws_stepfunctions_tasks_RunBatchJobProps(p) {
    ...
    if (!visitedObjects.has(p.dependsOn))
        _aws_cdk_aws_stepfunctions_tasks_JobDependency(p.dependsOn);
    if ("integrationPattern" in p)
...
function _aws_cdk_aws_stepfunctions_tasks_SageMakerCreateModelProps(p) {
    ...
    if (!visitedObjects.has(p.containers))
        _aws_cdk_aws_stepfunctions_tasks_IContainerDefinition(p.containers);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_EmrModifyInstanceGroupByName_InstanceGroupModifyConfigProperty(p) {
    ...
    if (!visitedObjects.has(p.configurations))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_ConfigurationProperty(p.configurations);
...
function _aws_cdk_aws_stepfunctions_tasks_EmrContainersStartJobRunProps(p) {
    ...
    if (!visitedObjects.has(p.applicationConfig))
        _aws_cdk_aws_stepfunctions_tasks_ApplicationConfiguration(p.applicationConfig);
...
function _aws_cdk_aws_stepfunctions_tasks_DynamoGetItemProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.key))
        _aws_cdk_aws_stepfunctions_tasks_DynamoAttributeValue(p.key);
    if (!visitedObjects.has(p.projectionExpression))
        _aws_cdk_aws_stepfunctions_tasks_DynamoProjectionExpression(p.projectionExpression);
...
function _aws_cdk_aws_stepfunctions_tasks_SageMakerCreateTrainingJobProps(p) {
    ...
    if (!visitedObjects.has(p.inputDataConfig))
        _aws_cdk_aws_stepfunctions_tasks_Channel(p.inputDataConfig);
...
function _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_EbsConfigurationProperty(p) {
    ...
    if (!visitedObjects.has(p.ebsBlockDeviceConfigs))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_EbsBlockDeviceConfigProperty(p.ebsBlockDeviceConfigs);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_AutoScalingPolicyProperty(p) {
    ...
    if (!visitedObjects.has(p.rules))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_ScalingRuleProperty(p.rules);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_InstanceFleetConfigProperty(p) {
    ...
    if (!visitedObjects.has(p.instanceTypeConfigs))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_InstanceTypeConfigProperty(p.instanceTypeConfigs);
...
function _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_InstancesConfigProperty(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.instanceFleets))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_InstanceFleetConfigProperty(p.instanceFleets);
    if (!visitedObjects.has(p.instanceGroups))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_InstanceGroupConfigProperty(p.instanceGroups);
...
function _aws_cdk_aws_stepfunctions_tasks_EmrCreateClusterProps(p) {
    ...
    if (!visitedObjects.has(p.applications))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_ApplicationConfigProperty(p.applications);
    if (!visitedObjects.has(p.bootstrapActions))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_BootstrapActionConfigProperty(p.bootstrapActions);
    if (!visitedObjects.has(p.configurations))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_ConfigurationProperty(p.configurations);
...
function _aws_cdk_aws_stepfunctions_tasks_DynamoPutItemProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.item))
        _aws_cdk_aws_stepfunctions_tasks_DynamoAttributeValue(p.item);
    if (!visitedObjects.has(p.expressionAttributeValues))
        _aws_cdk_aws_stepfunctions_tasks_DynamoAttributeValue(p.expressionAttributeValues);
    if (!visitedObjects.has(p.returnConsumedCapacity))
        _aws_cdk_aws_stepfunctions_tasks_DynamoConsumedCapacity(p.returnConsumedCapacity);
...
function _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_CloudWatchAlarmDefinitionProperty(p) {
    ...
    if (!visitedObjects.has(p.dimensions))
        _aws_cdk_aws_stepfunctions_tasks_EmrCreateCluster_MetricDimensionProperty(p.dimensions);
