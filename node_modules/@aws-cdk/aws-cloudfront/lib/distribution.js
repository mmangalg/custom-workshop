...
class Distribution extends core_1.Resource {
    ...
    renderViewerCertificate(certificate, minimumProtocolVersionProp, sslSupportMethodProp) {
        ...
        const sslSupportMethod = sslSupportMethodProp !== null && sslSupportMethodProp !== void 0 ? sslSupportMethodProp : SSLMethod.SNI;
        return {
...
Distribution[_a] = { fqn: "@aws-cdk/aws-cloudfront.Distribution", version: "1.153.1" };
...
AllowedMethods[_b] = { fqn: "@aws-cdk/aws-cloudfront.AllowedMethods", version: "1.153.1" };
/** HEAD and GET */
...
CachedMethods[_c] = { fqn: "@aws-cdk/aws-cloudfront.CachedMethods", version: "1.153.1" };
/** HEAD and GET */
