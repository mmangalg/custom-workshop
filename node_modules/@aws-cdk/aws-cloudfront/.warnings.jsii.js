...
function _aws_cdk_aws_cloudfront_DistributionProps(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.additionalBehaviors))
            _aws_cdk_aws_cloudfront_BehaviorOptions(p.additionalBehaviors);
        if (!visitedObjects.has(p.errorResponses))
            _aws_cdk_aws_cloudfront_ErrorResponse(p.errorResponses);
...
function _aws_cdk_aws_cloudfront_AddBehaviorOptions(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.edgeLambdas))
            _aws_cdk_aws_cloudfront_EdgeLambda(p.edgeLambdas);
        if (!visitedObjects.has(p.functionAssociations))
            _aws_cdk_aws_cloudfront_FunctionAssociation(p.functionAssociations);
        ...
        if (!visitedObjects.has(p.trustedKeyGroups))
            _aws_cdk_aws_cloudfront_IKeyGroup(p.trustedKeyGroups);
...
function _aws_cdk_aws_cloudfront_KeyGroupProps(p) {
    ...
    try {
        if (!visitedObjects.has(p.items))
            _aws_cdk_aws_cloudfront_IPublicKey(p.items);
    }
    finally {
        visitedObjects.delete(p);
    }
...
function _aws_cdk_aws_cloudfront_SourceConfiguration(p) {
    ...
    try {
        if (!visitedObjects.has(p.behaviors))
            _aws_cdk_aws_cloudfront_Behavior(p.behaviors);
        if (!visitedObjects.has(p.customOriginSource))
            _aws_cdk_aws_cloudfront_CustomOriginConfig(p.customOriginSource);
        if (!visitedObjects.has(p.failoverCriteriaStatusCodes))
            _aws_cdk_aws_cloudfront_FailoverStatusCode(p.failoverCriteriaStatusCodes);
...
function _aws_cdk_aws_cloudfront_Behavior(p) {
    ...
    try {
        ...
        if (!visitedObjects.has(p.lambdaFunctionAssociations))
            _aws_cdk_aws_cloudfront_LambdaFunctionAssociation(p.lambdaFunctionAssociations);
        if (!visitedObjects.has(p.trustedKeyGroups))
            _aws_cdk_aws_cloudfront_IKeyGroup(p.trustedKeyGroups);
...
function _aws_cdk_aws_cloudfront_CloudFrontWebDistributionProps(p) {
    ...
    visitedObjects.add(p);
    try {
        if (!visitedObjects.has(p.originConfigs))
            _aws_cdk_aws_cloudfront_SourceConfiguration(p.originConfigs);
        ...
        if (!visitedObjects.has(p.errorConfigurations))
            _aws_cdk_aws_cloudfront_CfnDistribution_CustomErrorResponseProperty(p.errorConfigurations);
        if (!visitedObjects.has(p.geoRestriction))
            _aws_cdk_aws_cloudfront_GeoRestriction(p.geoRestriction);
        if (!visitedObjects.has(p.httpVersion))
            _aws_cdk_aws_cloudfront_HttpVersion(p.httpVersion);
