...
function _aws_cdk_aws_codebuild_PipelineProjectProps(p) {
    ...
    if (!visitedObjects.has(p.environmentVariables))
        _aws_cdk_aws_codebuild_BuildEnvironmentVariable(p.environmentVariables);
    if (!visitedObjects.has(p.fileSystemLocations))
        _aws_cdk_aws_codebuild_IFileSystemLocation(p.fileSystemLocations);
...
function _aws_cdk_aws_codebuild_UntrustedCodeBoundaryPolicyProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.additionalStatements))
        require("@aws-cdk/aws-iam/.warnings.jsii.js")._aws_cdk_aws_iam_PolicyStatement(p.additionalStatements);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_codebuild_ProjectNotifyOnOptions(p) {
    ...
    if (!visitedObjects.has(p.events))
        _aws_cdk_aws_codebuild_ProjectNotificationEvents(p.events);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_codebuild_GitHubSourceProps(p) {
    if (p == null)
        return;
    visitedObjects.add(p);
    if (!visitedObjects.has(p.webhookFilters))
        _aws_cdk_aws_codebuild_FilterGroup(p.webhookFilters);
    visitedObjects.delete(p);
}
...
function _aws_cdk_aws_codebuild_ProjectProps(p) {
    ...
    if (!visitedObjects.has(p.secondaryArtifacts))
        _aws_cdk_aws_codebuild_IArtifacts(p.secondaryArtifacts);
    if (!visitedObjects.has(p.secondarySources))
        _aws_cdk_aws_codebuild_ISource(p.secondarySources);
...
function _aws_cdk_aws_codebuild_CfnProjectProps(p) {
    ...
    visitedObjects.add(p);
    if (!visitedObjects.has(p.artifacts))
        _aws_cdk_aws_codebuild_CfnProject_ArtifactsProperty(p.artifacts);
    if (!visitedObjects.has(p.source))
